...
class WebRtcAudioTrack {
    ...
    private final @Nullable IAudioCallBack audioCallBack;
        ...
        public void run() {
            ...
            while (keepAlive) {
                ...
                if (audioCallBack != null) {
                    audioCallBack.onAudioData(byteBuffer);
                }
//                long start = System.currentTimeMillis();
                int bytesWritten = audioTrack.write(byteBuffer, sizeInBytes, AudioTrack.WRITE_BLOCKING);
//                Log.e("am", "bytesWritten time ===> " + (System.currentTimeMillis() - start));
    ...
    WebRtcAudioTrack(Context context, AudioManager audioManager,
                     ...
                     boolean enableVolumeLogger, IAudioCallBack iAudioCallBack) {
