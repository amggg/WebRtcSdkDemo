...
public class VideoSource extends MediaSource {
    public static final int LIMIT_SEND_TIME = 500;
    /**
    ...
    private boolean isLimitSendFrame = true;
    private long lastLimitSendTime = 0;
    ...
    private boolean isAtLeastAndroid13() {
